...
__all__ = (
    'shield',
    'checkpoint', 'green_checkpoint',
    'checkpoint_if_cancelled', 'cancel_shielded_checkpoint',
    'threading_checkpoints_cvar', 'asyncio_checkpoints_cvar',
    'eventlet_checkpoints_cvar', 'curio_checkpoints_cvar',
    'gevent_checkpoints_cvar', 'trio_checkpoints_cvar',
)
...
threading_checkpoints_cvar = ContextVar('threading_checkpoints_cvar', default=(
    bool(os.getenv('AIOLOGIC_THREADING_CHECKPOINTS', ''))
))
eventlet_checkpoints_cvar = ContextVar('eventlet_checkpoints_cvar', default=(
    bool(os.getenv('AIOLOGIC_EVENTLET_CHECKPOINTS', ''))
))
gevent_checkpoints_cvar = ContextVar('gevent_checkpoints_cvar', default=(
    bool(os.getenv('AIOLOGIC_GEVENT_CHECKPOINTS', ''))
))

asyncio_checkpoints_cvar = ContextVar('asyncio_checkpoints_cvar', default=(
    bool(os.getenv('AIOLOGIC_ASYNCIO_CHECKPOINTS', ''))
))
curio_checkpoints_cvar = ContextVar('curio_checkpoints_cvar', default=(
    bool(os.getenv('AIOLOGIC_CURIO_CHECKPOINTS', ''))
))
trio_checkpoints_cvar = ContextVar('trio_checkpoints_cvar', default=(
    bool(os.getenv('AIOLOGIC_TRIO_CHECKPOINTS', '1'))
))
    ...
    try:
        ...
        try:
            from trio.lowlevel import (
                ...
                as trio_cancel_shielded_checkpoint,
            )
        except ImportError:
            async def trio_cancel_shielded_checkpoint():
                pass
